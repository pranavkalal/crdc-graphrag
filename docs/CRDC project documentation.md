...
2. [About RAG and GraphRAG](./reference_documents/about_RAG_GraphRAG.md)
3. [GraphRAG Patterns](#4-graphrag-patterns)
4. [System Architeture](#5-system-architecture)
...
5. [Agentic RAG](#6-agentic-rag)
6. [Constructing Knowledge Graphs with LLMs](#7-constructing-knowledge-graphs-with-llms)
7. [Microsoft GraphRAG](#8-microsoft-graphrag)
8. [Alternative GraphRAG Approaches](#9-alternative-graphrag-approaches)
9. [Neo4j as the Primary Database](#10-neo4j-as-the-primary-database)
10. [Strategy: Microsoft GraphRAG vs Custom Implementation](#11-strategy-microsoft-graphrag-vs-custom-implementation)
11. [Environment Selection: AI SDK vs Mastra vs LangGraph](#12-environment-selection-ai-sdk-vs-mastra-vs-langgraph)
12. [Project Direction and Scope](#13-project-direction-and-scope)
13. [Admin Features — Task 4.1](#14-admin-features--task-41)
14. [Evaluation](#15-evaluation)
15. [Implementation Roadmap](#16-implementation-roadmap)
16. [Risks and Mitigations](#17-risks-and-mitigations)
17. [Open Decisions and Missing Pieces](#18-open-decisions-and-missing-pieces)
18. [Immediate Next Steps](#19-immediate-next-steps)
